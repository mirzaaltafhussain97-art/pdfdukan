...
(function () {
      ...
      + '<div class="nav-item has-dropdown" tabindex="0" role="button" aria-haspopup="true" aria-expanded="false">'
        ...
        + '<div class="nav-dropdown mega" role="menu">'
          ...
          + '<div class="nd-col">'
            ...
            + '<a href="' + base + 'tools/ai-summarize.html"  class="nd-link" role="menuitem"><span class="nd-link-icon">&#129302;</span><div class="nd-link-body"><div class="nd-link-name">AI Summarizer</div><div class="nd-link-desc">Instant doc summary</div></div></a>'
  ...
  var mobileHTML = '<div class="mobile-nav-drawer" id="mobileNavDrawer" aria-label="Mobile menu">'
    ...
    + '<a href="' + base + 'tools/ai-summarize.html"  class="mnd-link">&#129302; AI Summarizer</a>'

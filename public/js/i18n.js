...
(function (global) {
  ...
  const _SUPPLEMENT = {
    ur: {
      ...
      'desc.delete-pages':'مخصوص صفحات ہٹائیں',
    ...
    ar: {
      ...
      'desc.page-numbers':'ترقيم تلقائي','desc.delete-pages':'حذف صفحات محددة',
    ...
    fr: {
      ...
      'tool.ocr':'OCR Texte','tool.watermark':'Filigrane',
    ...
    de: {
      ...
      'tool.ocr':'OCR Text','tool.fill-sign':'Ausfüllen & Unterschreiben',
